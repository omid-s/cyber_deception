 ...
 * @author omid
 *
 *         This class handles the main memory for the AI connector including the
 *         variables for each query that needs to be tracked
 * 
 */
public class AIConnectorMemory {
	...
	/***
	 * sets all the observations to zero 
	 */
	public void resetObservations() {
		for (int key : states_map.keySet()) {
			states_map.put(key, false);
		}
	}
